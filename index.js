...
es.isBinaryExpression = function(subTree) { return subTree.type === es.TYPES.BINARY_EXPRESSION; };
es.isCallExpression = function(subTree) { return subTree.type === es.TYPES.CALL_EXPRESSION; };
es.isConditionalExpression = function(subTree) { return subTree.type === es.TYPES.CONDITIONAL_EXPRESSION; };
