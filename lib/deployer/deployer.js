...
Deployer.prototype.getBundleURL = function(name, tag) {
    return this.options.codeManagerAssetReadHost + '/v1/blocks/' + name + '/versions/' + tag + '/assets/' + this.options.bundleAssetPath;
};

Deployer.prototype.getAssetURL = function(name, tag, assetPath) {
    return this.options.codeManagerAssetReadHost + '/v1/blocks/' + name + '/versions/' + tag + '/assets/' + assetPath;
};
...
Deployer.prototype.deploy = function(moduleName, moduleTag, selector, cb) {
    ...
    this.insertJavaScript(bundleURL, function() {
        ...
        this.whenIncludesAreReady(moduleName, moduleTag, function() {
            var component = this.execute(moduleName, moduleTag, selector);
            if (cb) cb(component);
        }.bind(this));
    }.bind(this));
};
