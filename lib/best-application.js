...
var WEBGL_GEOMETRY_KEY = '$geometry';
var BOX_KEY = '$box';
...
BestApplication.prototype.processDOMNodes = function(DOMNodes, parentBestNode) {
    for (var i = 0; i < DOMNodes.length; i++) {
        ...
        var stateManager = new StateManager(statesObject);
        ...
        if (surrogateRoot.childNodes.length) eventManager.send('yield', surrogateRoot.childNodes);
    ...
    for (var j = 0; j < handlerDeps.length; j++) {
        ...
        switch (handlerDep) {
            ...
            case WEBGL_MESH_KEY:
                ...
                break;
            case BOX_KEY:
                console.log('inside case of BOX_KEY')
                handlerArgs.push(this.famous.attachComponent(bestNode.famousNode, 'Box'));
                break;
            case GEOMETRY_KEY:
                console.log('inside case of GEOMETRY_KEY')
                handlerArgs.push(this.famous.attachComponent(bestNode.famousNode, 'Geometry'));
                break;
            default:
