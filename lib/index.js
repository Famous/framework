...
StateManager.prototype.add = function add(key, amount) {
  this.set(key, this.operate(key, amount, '+'));
  return this;
}
...
StateManager.prototype.pow = function pow(key, amount) {
  this.set(key, this.operate(key, amount, 'pow'));
  return this;
}
...
StateManager.prototype.sqrt = function sqrt(key) {
  this.set(key, this.operate(key, null, 'sqrt'));
  return this;
}
...
StateManager.prototype.abs = function abs(key) {
  this.set(key, this.operate(key, null, 'abs'));
  return this;
}
...
StateManager.prototype.sin = function sin(key) {
  this.set(key, this.operate(key, null, 'sin'));
  return this;
}
...
StateManager.prototype.cos = function cos(key) {
  this.set(key, this.operate(key, null, 'cos'));
  return this;
}
...
StateManager.prototype.tan = function tan(key) {
  this.set(key, this.operate(key, null, 'tan'));
  return this;
}
...
StateManager.prototype.ceil = function ceil(key) {
  this.set(key, this.operate(key, null, 'ceil'));
  return this;
}
...
StateManager.prototype.floor = function floor(key) {
  this.set(key, this.operate(key, null, 'floor'));
  return this;
}
...
StateManager.prototype.concat = function concat(key, amount) {
  this.set(key, this.operate(key, amount, 'concat'));
  return this;
}
...
StateManager.prototype.substring = function splice(key, amount) {
  this.set(key, this.operate(key, amount, 'substring'));
  return this;
}
...
StateManager.prototype.toLower = function toLower(key) {
  this.set(key, this.operate(key, null, 'toLower'));
  return this;
}
...
StateManager.prototype.toUpper = function toUpper(key) {
  this.set(key, this.operate(key, null, 'toUpper'));
  return this;
}
...
StateManager.prototype.flip = function flip(key) {
  this.set(key, this.operate(key, null, 'flip'));
  return this;
}
...
StateManager.prototype.toInt = function toInt(key) {
  this.set(key, this.operate(key, null, 'toInt'));
  return this;
}
 ...
 *
 * TODO: refactor structure of this._observers to prevent n^2 operation,
 *       very ugly right now
 */
StateManager.prototype._notifyObservers = function _notifyObservers(key, value) {
    for (var observable in this._observers) {
        for (var i in this._observers[observable]) {
            var observer = this._observers[observable][i];
            if (this._observerExists(key, observer)) {
                observer(key, value);
            }
        }
