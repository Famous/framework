    ...
    events: {
        ...
        '.grid-item' : {
            'front-tap' : function($state, $index, $dispatcher) {
                ...
                var bringToCenterTransition = $state.get('bringToCenterTransition');
                $state.set('isAnimating', 1, bringToCenterTransition)
                    .thenSet('isAnimating', 0);
                ...
                $dispatcher.trigger('position-modal', {
                    ...
                    transition: bringToCenterTransition,
                    direction: 'toCenter'
                });
            ...
            'back-tap' : function($state, $index, $dispatcher) {
                ...
                var returnFromCenterTransition = $state.get('returnFromCenterTransition');
                $state.set('isAnimating', 1, returnFromCenterTransition)
                    .thenSet('isAnimating', 0);
                ...
                $dispatcher.trigger('position-modal', {
                    ...
                    transition: returnFromCenterTransition,
