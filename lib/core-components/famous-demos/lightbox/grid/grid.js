...
FamousFramework.component('famous-demos:lightbox:grid', {
    behaviors: {
        ...
        '.grid-item' : {
            '$repeat' : function(itemCount) {
                var result = [];
                for (var i = 0; i < itemCount; i++) {
                    result.push({
                        'thumb-image': 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor_thumb.jpg',
                        'full-image': 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor.jpg',
                        'overlay-content': `<span class="overlay overlay-title">Francisco Goya y Lucientes, painter</span><br><span class="overlay overlay-date">1797 - 1799</span>`
                    });
                }
                return result;
            },
