...
var testingDataEntries = [];
for (var i = 0; i < 20; i++) {
    testingDataEntries.push({
        thumbnailURL: 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor_thumb.jpg',
        imageURL: 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor.jpg',
        hoverDescription: `<span class="overlay overlay-title">Francisco Goya y Lucientes, painter</span><br><span class="overlay overlay-date">1797 - 1799</span>`
    });
}
...
FamousFramework.component('famous-demos:lightbox:grid', {
    ...
    events: {
        ...
        '$private' : {
            ...
            'position-modal' : function($state, $payload) {
    ...
    states: {
        ...
        dataEntries: testingDataEntries,
        selectedIndex: null,
        scrollOffset: 0,
