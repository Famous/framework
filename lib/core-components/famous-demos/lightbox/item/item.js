...
FamousFramework.component('famous-demos:lightbox:item', {
    behaviors: {
        ...
        '#front-overlay' : {
            ...
            'align': [0.5, 0.5],
            'origin': [0.5, 0.5],
            'content' : function(overlayText, overlayDate) {
                return `
                    <div class="overlay-text">
                        <span class="overlay overlay-title">${overlayText}</span>
                        <br>
                        <span class="overlay overlay-date">${overlayDate}</span>
                    </div>
                `
            }
        },
    ...
    events: {
        '$lifecycle' : {
            'post-load' : function($state, $dispatcher) {
                $dispatcher.trigger('thumb-image', 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor_thumb.jpg');
                $dispatcher.trigger('full-image', 'https://s3-us-west-2.amazonaws.com/famous-framework/lightbox/caprichos/Museo_del_Prado_-_Goya_-_Caprichos_-_No._01_-_Autorretrato._Francisco_Goya_y_Lucientes2C_pintor.jpg');
    ...
    states: {
        ...
        overlayText: 'Francisco Goya y Lucientes, painter',
        overlayDate: '1797 - 1799',
