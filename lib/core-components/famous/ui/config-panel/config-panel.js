...
FamousFramework.component('famous:ui:config-panel', {
    behaviors: {
        ...
        '#panel': {
            ...
            'position': function(panelOpenness, panelWidth, zDepth) { return [-panelWidth + (panelWidth * panelOpenness), 0, zDepth]; },
            'style': {
        ...
        '#gradient': {
            'position': function(panelOpenness, panelWidth, zDepth) { return [-panelWidth + (panelWidth * panelOpenness), 0, zDepth + 1]; },
        ...
        '#toggle-button': {
            ...
            'position-z': function(zDepth) { return zDepth + 2; },
    ...
    events: {
        '$public': {
            ...
            'z-depth': function($state, $payload) {
                $state.set('zDepth', $payload);
            }
        },
