    ...
    states: {
        ...
        data: {
            groups: [{
                ...
                label: 'Lightbox',
                fields: [
                    { name: 'Deactivate Depth', type: 'int', value: 10, min: 0, max: 100 },
                    { name: 'Duration Variance', type: 'int', value: 30, min: 0, max: 100 }
                ]
            },{
                label: 'Title Transition',
                fields: [
                    { name: 'Title Spring Damping', type: 'string', value: 'Hello' },
                    { name: 'Title Spring Period', type: 'string', value: 'Goodbye' }
                ]
            },{
