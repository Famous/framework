...
ControlFlow.prototype.processRepeatBehaviors = function processRepeatBehaviors(blueprint, expandedBlueprint, uid) {
    ...
    for (var i = 0; i < repeatBehaviors.length; i++) {
        this.processRepeatBehavior(repeatBehaviors[i], blueprint, expandedBlueprint, uid);
    }
}

ControlFlow.prototype.processRepeatBehavior = function processRepeatBehavior(behavior, blueprint, expandedBlueprint, uid) {
