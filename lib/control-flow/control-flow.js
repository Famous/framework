...
function ControlFlow(behaviorList) {
    ...
    this.repeatData = {
        ...
        '.selector' :
            initialized: false,
            parentUIDs: [{uid1: {}}, {uid2: blueprintNode}],
            parentUIDs: [
                uid1: {
                    blueprint: node,
...
ControlFlow.prototype.processSelfContainedFlows = function processSelfContainedFlows(blueprint, uid) {
    ...
    this.processRepeat(blueprint, expandedBlueprint, uid);
...
ControlFlow.prototype.processRepeat = function processRepeat(blueprint, expandedBlueprint, uid) {
    ...
    for (var i = 0; i < repeatBehaviors.length; i++) {
        ...
        if (!data.initialized) {
            Repeat.findParentNodes(blueprint, behavior.selector, data);
