...
function Tree(name, uid, treeString, parentNode) {
    ...
    this.expandedBlueprint = null; // Set via event after control-flow
}
...
Tree.prototype.updateChildren = function updateChildren(childrenRoot) {
    VirtualDOM.transferChildNodes(childrenRoot, this.rootNode);
}
