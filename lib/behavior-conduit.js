...
BehaviorConduit.prototype.buildYieldController = function(behavior, behaviorDeps) {
    return function() {}
};

BehaviorConduit.prototype.buildRepeatController = function(behavior, behaviorDeps) {
    var treeString = this.bestApplication.bundle[this.bestNode.name].tree;
    var tree = DOM_PARSER.parseFromString(treeString, TREE_DATA_TYPE).body;
    ...
    return function() {
        ...
        var targetBestNode;
        var uid;
        for (var i = 0; i < repeatedTargets.length; i++) {
