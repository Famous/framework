...
Behaviors.processSelfBehavior = function processSelfBehavior(behavior, component) {
    console.log(component.name, 'self: ', behavior);
}

Behaviors.processTargetedBehavior = function processTargetedBehavior(behavior, component, targets) {
    console.log(component.name, 'target: ', behavior, targets);
}
