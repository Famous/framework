...
function addDefinition(name, definition) {
    ...
    DESCENDANT_EVENTS[name] = EVENTS[name][DESCENDANT_EVENTS_KEY] || {};
...
function getDescendantEvents(name) {
    return ObjUtils.clone(DESCENDANT_EVENTS[name]);
}
...
module.exports = {
    ...
    getDescendantEvents: getDescendantEvents,
