...
Timelines.prototype.start = function start() {
    var speed = this._currTimeline.speed || 1;
    ...
    this._states.set(this._currStateName, duration, { duration: duration / speed});
...
Timelines.prototype.resume = function resume() {
    var speed = this._currTimeline.speed || 1;
    var time = this._currTimeline.duration;

    var timeLeft = time - this._states.get(this._currStateName);

    this._states.set(this._currStateName, time, {duration: timeLeft / speed});
...
Timelines.prototype.rewind = function rewind() {
    ...
    this._states.set(this._currStateName, 0, {duration: timeElapsed / speed});
