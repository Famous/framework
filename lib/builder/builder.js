...
Builder.buildBundle = function(compilation, options, cb) {
    ...
    try {
        var importTupleString = builder.buildImportTupleString(compilation.dependencyTable);
        var mainCodeBlock = builder.buildMainCodeBlock(compilation.moduleName, compilation.moduleTag, compilation.entrypointAST);
        var bundleSource = builder.buildBundleSource(importTupleString, mainCodeBlock);
...
Builder.prototype.buildBundleSource = function(importTupleString, mainCodeBlock) {
    return this.options.mainPrefix +
           importTupleString +
           this.options.mainMidfix +
           mainCodeBlock +
           this.options.mainSuffix;
};
...
// Object -> Array
Builder.prototype.buildImportTupleString = function(dependencyTable) {
