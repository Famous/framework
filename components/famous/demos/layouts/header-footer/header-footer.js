BEST.module('famous:demos:layouts:header-footer', {
    ...
    behaviors: {
        '#header' : {
            ...
            its own content into the header/body/footer views like so:
            header-footer
                a#header
                b#body
                c#footer
            
            Component `a` will end up being slotted into the 'header' view, and as such will
